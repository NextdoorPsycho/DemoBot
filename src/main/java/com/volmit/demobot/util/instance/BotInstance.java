...
import com.volmit.demobot.commands.slash.LinksCommand;
import com.volmit.demobot.commands.slash.LogCommand;
import com.volmit.demobot.commands.slash.PingCommand;
import com.volmit.demobot.commands.slash.setup.SetupCommand;
import com.volmit.demobot.commands.slash.tickets.TicketMaster;
...
public class BotInstance {
    ...
    public BotInstance(String s) throws LoginException, InterruptedException {
        ...
        builder.addSlashCommand(new SetupCommand());
        builder.addSlashCommand(new LinksCommand());
